    ...
    <main class="mainContainer">
      ...
      <section class="section1 section my-5">
        <div class="container-fluid px-4 py-2 justify-content-center sendMessageForm">
          <form
            class="row d-flex align-items-center justify-content-center p-4 pageMargin contect-form">
            ...
            <button type="submit" class="SubmitBtn " id="Submit">Send Message<i class="SendIcon"></i></button>
            <!-- Alert Boxs -->
      ...
      <section class="section4 section">
        <div class="px-md-4">
          <div
            class="container-fluid p-3 d-flex align-items-start justify-content-center"
          >
